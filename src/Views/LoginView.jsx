...
function LoginView() {
    ...
    const { setUser, genres, setGenres, purHis } = useStoreContext();
    ...
    const googleSignIn = async () => {
        ...
        try {
            ...
            if (docSnap.exists()) {
                const data = docSnap.data();
                preferedGenres = data.genrePreferences;
            } else {
                preferedGenres = ["28", "12", "16", "80", "10751"]
                const data = { genrePreferences: preferedGenres, purchaseHistory: purHis.toJS() };
